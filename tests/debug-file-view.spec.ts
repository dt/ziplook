...
test("debug: file viewing selectors", async ({ page }) => {
  ...
  console.log(
    "File tree visible?",
    await page.locator(".file-tree").isVisible(),
  );
  ...
  if (textFileCount > 0) {
    ...
    console.log(
      ".file-viewer visible?",
      await page.locator(".file-viewer").isVisible(),
    );
    console.log(
      ".enhanced-file-viewer visible?",
      await page.locator(".enhanced-file-viewer").isVisible(),
    );
    console.log(
      ".monaco-editor visible?",
      await page.locator(".monaco-editor").isVisible(),
    );
    console.log(
      ".error-viewer visible?",
      await page.locator(".error-viewer").isVisible(),
    );
    ...
    console.log(
      ...
      await page.locator(".file-content").isVisible(),
    );
    console.log(
      ".view-lines visible?",
      await page.locator(".view-lines").isVisible(),
    );
    console.log(
      ".monaco-scrollable-element visible?",
      await page.locator(".monaco-scrollable-element").isVisible(),
    );
    ...
    console.log(
      ".main-panel visible?",
      await page.locator(".main-panel").isVisible(),
    );
    ...
    const editorElements = await page
      .locator('[class*="editor"], [class*="viewer"]')
      .count();
